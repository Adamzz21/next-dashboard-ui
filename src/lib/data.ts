...
export const calendarEvents = [
  {
    ...
    end: new Date(2026, 4, 18, 8, 45),
  },
  {
    title: "English",
    allDay: false,
    start: new Date(2026, 4, 18, 9, 0),
    end: new Date(2026, 4, 18, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 4, 18, 10, 0),
    end: new Date(2026, 4, 18, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 4, 18, 11, 0),
    end: new Date(2026, 4, 18, 11, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
  ...
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 4, 18, 14, 0),
    end: new Date(2026, 4, 18, 14, 45),
  },

  {
    title: "English",
    allDay: false,
    start: new Date(2026, 4, 19, 9, 0),
    end: new Date(2026, 4, 19, 9, 45),
  },
  {
    title: "Biology",
    allDay: false,
    start: new Date(2026, 4, 19, 10, 0),
    end: new Date(2026, 4, 19, 10, 45),
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 4, 19, 11, 0),
    end: new Date(2026, 4, 19, 11, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    ...
    end: new Date(2026, 4, 20, 10, 45),
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 4, 20, 13, 0),
    end: new Date(2026, 4, 20, 13, 45),
  },
  {
    title: "History",
    allDay: false,
  ...
  },
  {
    title: "Physics",
    allDay: false,
    start: new Date(2026, 4, 21, 11, 0),
    end: new Date(2026, 4, 21, 11, 45),
  },
  {
    title: "History",
    allDay: false,
    start: new Date(2026, 4, 21, 14, 0),
    end: new Date(2026, 4, 21, 14, 45),
  },

  {
    title: "Math",
    allDay: false,
    start: new Date(2026, 4, 22, 8, 0),
    end: new Date(2026, 4, 22, 8, 45),
  },
  {
    title: "English",
    allDay: false,
  ...
  },
  {
    title: "Chemistry",
    allDay: false,
    start: new Date(2026, 4, 22, 13, 0),
    end: new Date(2026, 4, 22, 13, 45),
  },
  {
    title: "History",
    allDay: false,
